...
@section('content')
<div class="page-container-wrap" style="margin-left:50px">
                                     ...
                                     <tbody>
                                      ...
                                      <td>{{$item['create_time']}}</td>
                                       <td>
                                            ...
                                            <a href="javascript:deleteGame({{$item['id']}})" class="btn btn-default btn-icon" style="color: red;"><i class="fa fa-trash-o"></i></a>
                                       </td>
                                    </tr>
                                      @endforeach
                                     </tbody>
