<div class="_1i0e0 _2siHy _38NUf _3aduF">
    <div class="_3Bswj">
        ...
        <form id="office_upload_form">
        <input type="hidden" name="_token" id="token" value="{{csrf_token()}}">
            <div class="_3KRvg">
                <div class="zfCs0">
                    <div><label class="TMFen" for="square">
                            <!-- react-text: 508 -->Surface habitable
                            <!-- /react-text --></label>
                ...
                <div class="_3GY3c">
                    <div><label class="_2GeK6" for="energy_rate">
                        ...
                        <div class="BtHSu _3CqQj" data-qa-id="select_toggle_energy_rate">
                            ...
                            <div class="uO-lw energy" data-qa-id="select_toggle_energy_rate_h" tabindex="0" value="h"
                                name="energy_rate">H</div>
                            <div class="uO-lw energy" data-qa-id="select_toggle_energy_rate_i" tabindex="0" value="i"
                                name="energy_rate">I</div>
                    ...
                    <div><label class="_2GeK6" for="ges">
                        ...
                        <div class="BtHSu _3CqQj" data-qa-id="select_toggle_ges">
                            ...
                            <div class="uO-lw ges" data-qa-id="select_toggle_ges_g" tabindex="0" value="g"
                                name="ges">G</div>
                            <div class="uO-lw ges" data-qa-id="select_toggle_ges_h" tabindex="0" value="h" name="ges">
                                H</div>
                            <div class="uO-lw ges" data-qa-id="select_toggle_ges_i" tabindex="0" value="i"
                                name="ges">I</div>
    ...
    <div class="_1aYAF">
        ...
        <div><span>
                <!-- react-text: 683 -->Mettez en valeur votre annonce !
                <!-- /react-text --><br><br><!-- react-text: 686 -->Plus il y a de détails, plus votre futur acheteur
