<div class="_1i0e0 _2siHy _38NUf _3aduF">
            ...
            <div class="_3KRvg">
                            ...
                            <div class="_3Fc4U" data-qa-id="select_icon_real_estate_type">
                                ...
                                <div class="_2GSq7" data-qa-id="select_icon_real_estate_type_4" tabindex="0" value="4"
                                    ...
                                    <div class="e4Ae2"><span class="_1vK7W" name="parking"><svg height="24" width="24"
                                                ...
                                                <path
                                                    d="M22 22V7.344L12 2.127 2 7.345V22h1.826V11.52a1 1 0 0 1 1-1h14.348a1 1 0 0 1 1 1V22H22zM5.826 13.64h12.348v-1.119H5.826v1.12zm0 2.87h12.348v-1.37H5.826v1.37zm0 2.87h12.348v-1.37H5.826v1.37zm0 2.62h12.348v-1.12H5.826V22zM23.463 5.851c.33.172.537.513.537.886V23a1 1 0 0 1-1 1H1a1 1 0 0 1-1-1V6.74c0-.374.207-.715.537-.887l11-5.74c.291-.15.635-.15.926 0l11 5.74zM7.696 7.194a.5.5 0 0 1 .5.5v.956a.5.5 0 0 1-.5.5h-2.87a.5.5 0 0 1-.5-.5v-.956a.5.5 0 0 1 .5-.5h2.87zm2.37.5a.5.5 0 0 1 .5-.5h2.869a.5.5 0 0 1 .5.5v.956a.5.5 0 0 1-.5.5h-2.87a.5.5 0 0 1-.5-.5v-.956zm6.239 1.457a.5.5 0 0 1-.5-.5v-.956a.5.5 0 0 1 .5-.5h2.869a.5.5 0 0 1 .5.5v.956a.5.5 0 0 1-.5.5h-2.869z"
                                                    fill="#1A1A1A"></path>
                                            </svg></span></div>
                ...
                <div class="zfCs0">
                    <div><label class="TMFen" for="square">
                            <!-- react-text: 8533 -->Surface habitable
                            <!-- /react-text --></label>
                        <div class="_2wuZK"><input type="text" class="_2erBM" data-qa-id="newad-input_square"
                                maxlength="6" value="" name="square"><span class="_2x7fK">m²</span></div>
                    </div>
                </div>
                <div class="zfCs0">
                    <div><label class="TMFen" for="rooms">
                            <!-- react-text: 8541 -->Nombre de pièces
                            <!-- /react-text --></label>
                        <div class="_2wuZK"><input type="text" class="_2erBM" data-qa-id="newad-input_rooms"
                                maxlength="2" value="" name="rooms"><span class="_2x7fK">pièce(s)</span></div>
                    </div>
                </div>
                <div class="_3GY3c">
                    <div><label class="_2GeK6" for="energy_rate">
                            <div class="_2uqjM">
                                ...
                                <div class="_1Rlsj"><span class="_1vK7W" name="info"><svg viewBox="0 0 24 24"
                                            data-name="Calque 1" focusable="false">
                                            <path
    ...
    <div class="_1aYAF">
        ...
        <div><span>
                <!-- react-text: 9402 -->Mettez en valeur votre annonce !
                <!-- /react-text --><br><br><!-- react-text: 9405 -->Plus il y a de détails, plus votre futur acheteur
