                ...
                <div class="_3KRvg">
                    ...
                    <div class="zfCs0">
                        <div><label class="TMFen" for="mileage">
                            ...
                            <div class="_2wuZK">
                            <input type="text" class="_2erBM" data-qa-id="newad-input_mileage"
                                    maxlength="6" value="" name="mileage">
                                    <span class="_2x7fK">
                                    <font style="vertical-align: inherit;">
                    ...
                    <div class="zfCs0">
                        <div><label class="TMFen" for="issuance_date">
                            ...
                            <div class="_2wuZK">
                            <input type="text" class="_2erBM" data-qa-id="input_issuance_date"
                                    maxlength="7" placeholder="MM / AAAA" value="" name="issuance_date">
                                    </div>
                        </div>
                    </div>
                </div>
            ...
            <div><span>
                    ...
                    <font style="vertical-align: inherit;">
                        ...
                        <font style="vertical-align: inherit;">The more details, the sooner your future buyer will find
                            you.</font>
                    </font><!-- /react-text --><br><br><!-- react-text: 1968 -->
