...
<body>
    ...
    <section>
        <div>
            ...
            <div class="_3z3iI">
                <div class="C3JS5">
                    <div data-qa-id="adview_sticky_container" class="_1i0e0 _2hhPz">
                        <div class="i6ptl">
                            <div class="DOqg6 trackable">
                                <div class="_2SO8i" data-qa-id="adview_sticky_image"><img
                                        src="https://img0.leboncoin.fr/ad-thumb/8abe2231721be5509e47a41bda224fa309bf6b9f.jpg">
                                </div>
                                <div data-qa-id="adview_title">
                                    <div>
                                        <h3 class="_1jI08">Taille haie WOLF</h3>
                                    </div>
                                    <div class="_1HRrn" data-qa-id="adview_price">
                                        <div class="_386c2">
                                            <!-- react-text: 5839 -->
                        ...
                        <div class="_3p0gz">
                            <div class="_2vdii">
                                <div class="_1wspb" data-qa-id="adview_button_phone" data-pub-id="clicknumero">
                                    <div>
                                        <div><button class="_2sNbI ObuDQ GXQkc _2xk2l"
                                                data-qa-id="adview_button_phone_contact"><span
                                                    class="_1vK7W _1eOK1 QKFCn" name="phone"><svg viewBox="0 0 24 24"
                                                    ...
                                                    </svg></span><!-- react-text: 5853 -->Contacter
                                ...
                                <div class="_1wspb trackable" data-qa-id="adview_button_contact_sticky">
                                    <div>
                                        ...
                                        data-qa-id="offer-button"><span class="_1vK7W _1eOK1 QKFCn"
                                            ...
                                            </svg></span><!-- react-text: 6301 -->Faire une offre
                                        <!-- /react-text --></button></span>
                            </div>
                        </div>
                        <div class="_2Dlhe">
                            <div class="_13HNN" data-qa-id="adview_button_favorite-sticky">
                                <div>
                                    <div class="_3C4to">
                                        <div class="_1vQK7"><span class="_1vK7W" name="heartoutline"><svg
