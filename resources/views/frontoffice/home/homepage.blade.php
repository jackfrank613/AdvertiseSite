                                ...
                                <div class="_2lehD _11PoU" data-reactid="237">
                                    <div class="_11AC0" data-reactid="238">
                                        <ul data-reactid="239">
                                           ...
                                           <li data-reactid="240"><a title="{{$item['st_name']}}" data-map="{{$item['st_id']}}"
                                            class="_3mctU trackable" href="{{URL::to('frontoffice/aditems/offer')}}/{{$item['r_name']}}" data-reactid="241">{{$item['st_name']}}</a></li>  
                                           @endforeach
...
<script>
    $(document).ready(function () {
        ...
        var i;
        $('._3mctU').mouseover(function(){
            var target  = $(this).data('map');
            console.log(target);
            $('g#' + target).addClass("_3g5HG");
        }); 
        
        $('._3mctU').mouseout(function(){
        
            var target  = $(this).data('map');
            console.log(target);
            $('g#' + target).removeClass("_3g5HG");
        });
        ...
        $('g').mouseover(function(){
          ...
          console.log(id);
          if(id != "")
          $('a[data-map=' + id + ']').addClass("_mapBack");
        ...
        $('g').mouseout(function(){
          ...
          console.log(id);
          if(id != "")
          $('a[data-map=' + id + ']').removeClass("_mapBack");
